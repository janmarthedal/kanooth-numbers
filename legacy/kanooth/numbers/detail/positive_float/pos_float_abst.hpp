...
// Type traits related to numb<posfloatnum<T, E, P> >

template <typename T, typename E, std::size_t P>
struct is_signed<numbers::detail::numb<numbers::detail::posfloatnum<T, E, P> > >
  : public false_type {};

template <typename T, typename E, std::size_t P>
struct make_unsigned<numbers::detail::numb<numbers::detail::posfloatnum<T, E, P> > >
  : public set_type<numbers::detail::numb<numbers::detail::posfloatnum<T, E, P> > > {};
